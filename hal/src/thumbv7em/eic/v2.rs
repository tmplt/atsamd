...
use crate::clock::v2::pclk::Pclk;
use crate::gpio::v2::{
    self as gpio, AnyPin, AlternateA, PinId, Pin, Interrupt, InterruptConfig
};
use crate::typelevel::Sealed;

use crate::pac::eic::ctrla::CKSEL_A;
...
impl<E: EINum> Registers<E> {
    ...
    unsafe fn new() -> Self {
        Registers { ei_num: PhantomData }
    }

    fn eic(&self) -> &crate::pac::EIC {
    ...
    K: EIClkSrc,
{
    ...
    pub fn enable_debouncer(&mut self, eic: &mut EIController) {
...
//pub type EIController {
    //eic: crate::pac::EIC,
//}

//impl EIController {
    //// Safe because you trade a singleton PAC struct for new singletons
    //pub fn new(eic: crate::pac::EIC) -> (Self, Tokens) {
        //unsafe { ( Self { eic }, Tokens::new() ) }
    //}
