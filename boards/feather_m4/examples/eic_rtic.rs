//! Configure and exercise the EIC abstraction
#![no_main]
#![no_std]
...
mod app {
    ...
    struct LocalResources {
        ext_int_00: ExtInt<PA16, Floating, AsyncOnly, WithoutClock, SenseHigh>,
        ext_int_01: ExtInt<PA17, Floating, AsyncOnly, WithoutClock, SenseLow>,
